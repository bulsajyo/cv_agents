...
# initialize
V_MAX = 2000.0      # maximum velocity [m/s]
ACC_MAX = 200.0 # maximum acceleration [m/ss]
K_MAX = 400.0    # maximum curvature [1/m]

TARGET_SPEED = 20.0/3.6 # target speed [m/s]
LANE_WIDTH = 0.19  # lane width [m]

COL_CHECK = 0.19 # collision check distance [m]
